...
analysis_folder_path = r"Z:\Users\Emma\Zyla1\2026_03\Netztraeger46\260325\perylene\Meas2\hlh_analysis"
poni_name = "UEDPerylExp14_cyc1.poni"
mask_name = "peryl_exp14_mask.npy"
pumpedH5_name = "exp14_25cyc_woarcs_hpxrm.h5"
pdf_name = "Peryl_exp14_hpxrm_azigral.pdf"

# set some variables
t0_set = 10 #guess set by hand due to knowledge of measurement in ps
...
qs, lo_pumpoff = poni.integrate1d(long_pumpoff, npt=1024, mask=mask, unit="q_A^-1", radial_range=(1, 9))
_, lo_mean_pumped =  poni.integrate1d(np.mean(pumped_data, axis=0), npt=1024, mask=mask, unit="q_A^-1", radial_range=(1, 9))
_, lo_mean_before = poni.integrate1d(mean_before, npt=1024, mask=mask, unit="q_A^-1", radial_range=(1, 9))
...
for delay_img in pumped_data:
    _, lo = poni.integrate1d(delay_img, npt=1024, mask=mask, unit="q_A^-1", radial_range=(1, 9))
